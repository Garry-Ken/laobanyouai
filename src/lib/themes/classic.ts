...
export const classicThemes: Theme[] = [
  ...
  },
  {
    id: 'media',
    name: 'NYT',
    description: '经典米黄色新闻纸，严肃深度报道专业感',
    styles: {
      ...
      h1: 'font-size: 32px; font-weight: 700; color: #111 !important; line-height: 1.3 !important; margin: 38px 0 16px; border-bottom: 2px solid #000; padding-bottom:12px;',
  ...
  },
  {
    id: 'linear',
    name: 'Linear',
    description: '纯正暗夜赛博极客风，编程教程与开发日志',
    styles: {
      ...
      h1: 'font-size: 32px; font-weight: 700; color: #fff !important; line-height: 1.3 !important; margin: 38px 0 16px;',
